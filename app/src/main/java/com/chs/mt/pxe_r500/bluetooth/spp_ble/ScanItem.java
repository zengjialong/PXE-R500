...
public class ScanItem extends RelativeLayout {
    ...
    //结构函数
    public ScanItem(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }
    public ScanItem(Context context, AttributeSet attrs) {
    ...
    private void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.chs_viewitem_scaningitem, this);
