...
public class KnobView_AP extends ImageView {
    ...
    public KnobView_AP(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        mAttrs = attrs;
        init(context);
...
//        setMeasuredDimension(min, min);
        ...
        InsideRadius = (float) (drawableRadius*0.73);
        OutsideRadius= (float) (drawableRadius*0.77);
...
//    	    System.out.println("FUCK scaleHeight:"+scaleHeight);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //drawFullCir(canvas);
        canvas.drawArc(arcRect, START_ANGLE, 360, false, progressPaint);
        drawProgress(canvas);
        drawThumb(canvas);
    ...
    private void drawProgress(Canvas canvas){
        canvas.drawArc(arcRect, START_ANGLE-30, 30, false, progressPaint2);
    ...
    public void setTouchable(boolean touchable) {
     ...
     private void rotateWheel(float degrees) {
        ...
        if(mProListener != null){
            mProListener.onProgressChanged(KnobView_AP.this,true, getProgress());
        }
    }
    ...
    private void setAngle(float angle, boolean callback) {
        ...
        if (wheelWidth == 0 || wheelHeight == 0) {
            ...
            if(mProListener != null){
                mProListener.onProgressChanged(KnobView_AP.this,false, getProgress());
            }
        }
    }
        ...
        public boolean onTouch(View v, MotionEvent event) {
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_DOWN:
                    ...
                    if(mProListener != null){
                        mProListener.onStartTrackingTouch(KnobView_AP.this, getProgress());
                    }
                    if (!touchable) {
                        return false;
                    }
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if(mProListener != null){
                        mProListener.onStopTrackingTouch(KnobView_AP.this, getProgress());
                    }
                    break;
            }
...
//        chs_progress = Math.max(1, chs_progress);
    ...
    public interface OnProgressChangeListener{
        ...
        void onProgressChanged(KnobView_AP view, boolean fromUser, int progress);

        void onStartTrackingTouch(KnobView_AP view, int progress);
        void onStopTrackingTouch(KnobView_AP view, int progress);
    }
}
