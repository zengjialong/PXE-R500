...
public class KnobViewTPV extends ImageView {
    ...
    public KnobViewTPV(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        mAttrs = attrs;
        init(context);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {  
        ...
        radius = (float) (drawableRadius*0.85);//��Seekbar����λ�ð뾶
...
//        canvas.restore();
    ...
    private void rotateWheel(float degrees) {
        ...
        if(mProListener != null){
            mProListener.onProgressChanged(KnobViewTPV.this,true, getProgress());
        }
    }
    ...
    private void setAngle(float angle, boolean callback) {
        ...
        if (wheelWidth == 0 || wheelHeight == 0) {
            ...
            if(mProListener != null){
                mProListener.onProgressChanged(KnobViewTPV.this,false, getProgress());
            }
        }
    }
    ...
    public interface RotateChangeListener {
         ...
         *
         * @param degress
         * @param fromUser �Ƿ�ͨ����ת�ķ�ʽʹ�Ƕȸı�,������ͨ��{@link KnobViewTPV#setAngle(float)}}����
         */
        ...
        public boolean onTouch(View v, MotionEvent event) {
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_DOWN:
                    ...
                    if(mProListener != null){
                        mProListener.onStartTrackingTouch(KnobViewTPV.this, getProgress());
                    }
                    if (!touchable) {
                        return false;
                    }
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if(mProListener != null){
                        mProListener.onStopTrackingTouch(KnobViewTPV.this, getProgress());
                    }
                    break;
            }
...
//        progress = Math.max(1, progress);
    ...
    public interface OnProgressChangeListener{
         ...
         * @param progress
         */
        void onProgressChanged(KnobViewTPV view,boolean fromUser, int progress);
         ...
         * @param progress
         */
        void onStartTrackingTouch(KnobViewTPV view, int progress);
         ...
         * @param progress
         */
        void onStopTrackingTouch(KnobViewTPV view, int progress);
    }
}
