...
public class KnobViewLineFl extends ImageView {
    ...
    public KnobViewLineFl(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        mAttrs = attrs;
        init(context);
...
//        canvas.restore();
    ...
    private void rotateWheel(float degrees) {
        ...
        if(mProListener != null){
            mProListener.onProgressChanged(KnobViewLineFl.this,true, getProgress());
        }
    }
    ...
    private void setAngle(float angle, boolean callback) {
        ...
        if (wheelWidth == 0 || wheelHeight == 0) {
            ...
            if(mProListener != null){
                mProListener.onProgressChanged(KnobViewLineFl.this,false, getProgress());
            }
        }
    }
    ...
    public interface RotateChangeListener {
         ...
         *
         * @param degress
         * @param fromUser �Ƿ�ͨ����ת�ķ�ʽʹ�Ƕȸı�,������ͨ��{@link KnobViewLineFl#setAngle(float)}}����
         */
        ...
        public boolean onTouch(View v, MotionEvent event) {
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_DOWN:
                    ...
                    if(mProListener != null){
                        mProListener.onStartTrackingTouch(KnobViewLineFl.this, getProgress());
                    }
                    if (!touchable) {
                        return false;
                    }
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if(mProListener != null){
                        mProListener.onStopTrackingTouch(KnobViewLineFl.this, getProgress());
                    }
                    break;
            }
...
//        progress = Math.max(1, progress);
    ...
    public interface OnProgressChangeListener{
         ...
         * @param progress
         */
        void onProgressChanged(KnobViewLineFl view,boolean fromUser, int progress);
         ...
         * @param progress
         */
        void onStartTrackingTouch(KnobViewLineFl view, int progress);
         ...
         * @param progress
         */
        void onStopTrackingTouch(KnobViewLineFl view, int progress);
    }
}
