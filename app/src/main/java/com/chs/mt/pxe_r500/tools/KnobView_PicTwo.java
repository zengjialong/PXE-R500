...
public class KnobView_PicTwo extends AppCompatImageView {
    ...
    public KnobView_PicTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        mAttrs = attrs;
        init(context);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {  
        ...
        InsideRadius = (float) (drawableRadius*0.25);
        OutsideRadius= (float) (drawableRadius*0.5);
...
//        canvas.restore();
    ...
    private void rotateWheel(float degrees) {
        ...
        if(mProListener != null){
            mProListener.onProgressChanged(KnobView_PicTwo.this,true, getProgress());
        }
    }
    ...
    private void setAngle(float angle, boolean callback) {
        ...
        if (wheelWidth == 0 || wheelHeight == 0) {
            ...
            if(mProListener != null){
                mProListener.onProgressChanged(KnobView_PicTwo.this,false, getProgress());
            }
        }
    }
        ...
        public boolean onTouch(View v, MotionEvent event) {
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_DOWN:
                    ...
                    if(mProListener != null){
                        mProListener.onStartTrackingTouch(KnobView_PicTwo.this, getProgress());
                    }
                    if (!touchable) {
                        return false;
                    }
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if(mProListener != null){
                        mProListener.onStopTrackingTouch(KnobView_PicTwo.this, getProgress());
                    }
                    break;
            }
...
//        chs_progress = Math.max(1, chs_progress);
    ...
    public interface OnKnobView_PicTwo_ProgressChangeListener{
        ...
        void onProgressChanged(KnobView_PicTwo view, boolean fromUser, int progress);

        void onStartTrackingTouch(KnobView_PicTwo view, int progress);

        void onStopTrackingTouch(KnobView_PicTwo view, int progress);
    }
}
