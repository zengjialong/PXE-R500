...
public class KnobViewLine extends ImageView {
    ...
    public KnobViewLine(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        mAttrs = attrs;
        init(context);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {  
        ...
        radius = (float) (drawableRadius*0.75);
        thumbRadius = radius;//thumbRadius
...
//        canvas.restore();
    ...
    public void setTouchable(boolean touchable) {
     ...
     private void rotateWheel(float degrees) {
        ...
        if(mProListener != null){
            mProListener.onProgressChanged(KnobViewLine.this,true, getProgress());
        }
    }
    ...
    private void setAngle(float angle, boolean callback) {
        ...
        if (wheelWidth == 0 || wheelHeight == 0) {
            ...
            if(mProListener != null){
                mProListener.onProgressChanged(KnobViewLine.this,false, getProgress());
            }
        }
    }
        ...
        public boolean onTouch(View v, MotionEvent event) {
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_DOWN:
                    ...
                    if(mProListener != null){
                        mProListener.onStartTrackingTouch(KnobViewLine.this, getProgress());
                    }
                    if (!touchable) {
                        return false;
                    }
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if(mProListener != null){
                        mProListener.onStopTrackingTouch(KnobViewLine.this, getProgress());
                    }
                    break;
            }
...
//        chs_progress = Math.max(1, chs_progress);
    ...
    public interface OnProgressChangeListener{
        ...
        void onProgressChanged(KnobViewLine view,boolean fromUser, int progress);

        void onStartTrackingTouch(KnobViewLine view, int progress);
        void onStopTrackingTouch(KnobViewLine view, int progress);
    }
}
