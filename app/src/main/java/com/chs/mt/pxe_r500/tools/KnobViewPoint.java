...
public class KnobViewPoint extends ImageView {
    ...
    private static final float PROG_RATIO = 0.72f;
    ...
    public KnobViewPoint(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        mAttrs = attrs;
        init(context);
    ...
    private void initView(){
        TypedArray localTypedArray = mContext.obtainStyledAttributes(mAttrs, R.styleable.KNOB);
     	...
     	inside_point_color = localTypedArray.getColor(R.styleable.KNOB_inside_point_color, getResources().getColor(R.color.color_main));
     	outside_point_color_press = localTypedArray.getColor(R.styleable.KNOB_outside_point_color_press, getResources().getColor(R.color.color_main));
     	outside_point_color_normal = localTypedArray.getColor(R.styleable.KNOB_outside_point_color_normal, getResources().getColor(R.color.color_main));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {  
        ...
        radius = drawableRadius -thumbHalfWidth;
        thumbRadius = radius;
...
//        canvas.restore();
    ...
    private void drawInsidePoint(Canvas canvas) {
    	float[] pointerPosition=calculatePointerPosition(325-mprogress*ratio, InsideRadius);
        ...
        public boolean onTouch(View v, MotionEvent event) {
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_DOWN:
                    ...
                    if(mProListener != null){
                        mProListener.onStartTrackingTouch(KnobViewPoint.this, getProgress());
                    }
                    if (!touchable) {
                        return false;
                    }
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if(mProListener != null){
                        mProListener.onStopTrackingTouch(KnobViewPoint.this, getProgress());
                    }
                    break;
            }
...
//        chs_progress = Math.max(1, chs_progress);
    ...
    public interface OnProgressChangeListener{
        ...
        void onStartTrackingTouch(KnobViewPoint view, int progress);

        void onStopTrackingTouch(KnobViewPoint view, int progress);
    }
}
